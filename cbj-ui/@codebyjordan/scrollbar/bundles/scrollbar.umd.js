(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Observable'), require('rxjs/add/observable/fromEvent'), require('rxjs/Subject'), require('rxjs/add/observable/from'), require('rxjs/add/observable/merge'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/takeUntil'), require('rxjs/add/operator/map'), require('@angular/common'), require('rxjs/add/operator/filter'), require('@angular/router')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Observable', 'rxjs/add/observable/fromEvent', 'rxjs/Subject', 'rxjs/add/observable/from', 'rxjs/add/observable/merge', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/takeUntil', 'rxjs/add/operator/map', '@angular/common', 'rxjs/add/operator/filter', '@angular/router'], factory) :
	(factory((global.scrollbar = {}),global.ng.core,global.Rx,global.Rx.Observable,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.common,global.Rx.Observable.prototype,global.ng.router));
}(this, (function (exports,core,Observable,fromEvent,Subject,from,merge,mergeMap,takeUntil,map,common,filter,router) { 'use strict';
...
var ScrollbarService = (function () {
    ...
    ScrollbarService.prototype.initWheel = function (el) {
        var /** @type {?} */ dommousescroll = Observable.Observable.fromEvent(el, 'DOMMouseScroll');
        var /** @type {?} */ mousewheel = Observable.Observable.fromEvent(el, 'mousewheel');
        var /** @type {?} */ wheel = Observable.Observable.fromEvent(el, 'wheel');
        return Observable.Observable.merge.apply(Observable.Observable, [dommousescroll, mousewheel, wheel]).map(function (e) {
            e.preventDefault();
    ...
    ScrollbarService.prototype.initDrag = function (el, bar) {
        var /** @type {?} */ observs;
        var /** @type {?} */ mousemove = Observable.Observable.fromEvent(this.ws.window, 'mousemove');
        var /** @type {?} */ mousedown = Observable.Observable.fromEvent(bar, 'mousedown');
        var /** @type {?} */ mouseup = Observable.Observable.fromEvent(this.ws.window, 'mouseup');
        ...
        if (this.ws.isMobile) {
            var /** @type {?} */ touchmove_1 = Observable.Observable.fromEvent(this.ws.window, 'touchmove');
            var /** @type {?} */ touchstart = Observable.Observable.fromEvent(el, 'touchstart');
            var /** @type {?} */ touchend_1 = Observable.Observable.fromEvent(this.ws.window, 'touchend');
            ...
            observs = {
                start: Observable.Observable.merge.apply(Observable.Observable, [mousedrag, touchdrag]),
                end: Observable.Observable.merge.apply(Observable.Observable, [mouseup, touchend_1]),
                move: Observable.Observable.merge.apply(Observable.Observable, [mousemove, touchstart])
            };
        }
        return observs;
    };
